...
- Next.js Best Practices such as
  - File-based routing, Data fetching that allows server-side rendering and static generation which makes your websites incredibly optimized (getServerSideProps, getStaticPaths, getStaticProps), and use Next.js as a backend endpoint.
